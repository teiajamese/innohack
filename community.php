...
<head>
	...
	<title>Sartre | Multipurpose HTML5 Template - Portfolio</title>
	...
	<div class="wrapper reveal-side-navigation">
		<div class="wrapper-inner">
										...
										<ul class="sub-menu">
											...
											<li class="contains-sub-menu">
												...
												<ul class="sub-menu">
													...
													<li>
														<a href="index-travel-agency-one-page.html">One Page <span class="label">New</span></a>
													</li>
												</ul>
											</li>
											<li class="contains-sub-menu">
											...
											<li class="contains-sub-menu">
												...
												<ul class="sub-menu">
													...
													<li>
														<a href="index-architecture-2.html">Variation 2 <span class="label">Updated</span></a>
													</li>
													<li>
			...
			<div class="content clearfix">
				...
				<div class="section-block grid-container full-width no-margins fade-in-progressively no-padding-top" data-layout-mode="masonry" data-grid-ratio="1.5" data-animate-filter-duration="700" data-set-dimensions data-animate-resize data-animate-resize-duration="0">
					<div class="row">
						<div class="column width-12">
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">Cross</span>
													</span>
												</span>
											</span>
										</a>
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">Banana R</span>
													</span>
												</span>
											</span>
										</a>
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">White</span>
													</span>
												</span>
											</span>
										</a>
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">Got Swag</span>
													</span>
												</span>
											</span>
										</a>
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">Swift</span>
													</span>
												</span>
											</span>
										</a>
									...
									<div class="thumbnail img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9">
										<a class="overlay-link" href="project-style-one.html">
											...
											<span class="overlay-info">
												<span>
													<span>
														<span class="project-title">Get Up</span>
													</span>
												</span>
											</span>
										</a>
